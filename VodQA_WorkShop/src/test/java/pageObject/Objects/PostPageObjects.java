...
public class PostPageObjects {
    @AndroidFindAll({@AndroidFindBy(xpath = ".//*[@text='Title1']"), //incorrect locator which will be ignored
        @AndroidFindBy(id = "org.wordpress.android:id/post_title")}) public MobileElement postTitle;
